...
The general-case member moved to `aut2ltl.kr.muller` and was renamed `muller` (its
...
"""
from aut2ltl.kr.muller import muller as bls, Muller as Bls, assemble_muller_dnf
